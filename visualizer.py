...
for i in range(len(frag)):
    ...
    # Make sure the sequences are aligned properly - sometimes they could wrap around each other since this is a circular plasmid
...
# Plot the record and save it to disk
